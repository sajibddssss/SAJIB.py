...
colouroff="\x1b[00m"
logo=""" 
\033[1;91m  sSSs   .S_SSSs        .S   .S   .S_SSSs    
 d%%SP  .SS~SSSSS      .SS  .SS  .SS~SSSSS   
d%S'    S%S   SSSS     S%S  S%S  S%S   SSSS  
S%|     S%S    S%S     S%S  S%S  S%S    S%S  
S&S     S%S SSSS%S     S&S  S&S  S%S SSSS%P  
Y&Ss    S&S  SSS%S     S&S  S&S  S&S  SSSY   
`S&&S   S&S    S&S     S&S  S&S  S&S    S&S  
  `S*S  S&S    S&S     S&S  S&S  S&S    S&S  
   l*S  S*S    S&S     d*S  S*S  S*S    S&S  
  .S*P  S*S    S*S    .S*S  S*S  S*S    S*S  
sSS*S   S*S    S*S  sdSSS   S*S  S*S SSSSP   
YSS'    SSS    S*S  YSSY    S*S  S*S  SSY    
               SP           SP   SP          
               Y            Y    Y           
...
\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            SAJIB AHMED
     \033[1;91m➣ \033[1;91mFACEBOOK   :            SAJIB AHMED
     \033[1;92m➣ \033[1;92mWHATSAPP   :            01325167141
     \033[1;91m➣ \033[1;91mGITHUB     :            Sheikh-Sajib374
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;92m Total OK : \x1b[1;91m %s  \x1b[1;92mSAJIB_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;91m Total CP :\x1b[1;91m   %s \x1b[1;91mSAJIB_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;93mPress enter to back SAJIB Menu ")
	    sarfraz()
